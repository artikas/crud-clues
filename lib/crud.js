...
var crud = {
  ...
  // a more custom function. Goes through the mongoose model so that the
  // object constraints are enforced. Assigns a user_id if possible.
  valid_input: function($model, input_data, _user_id) {
    ...
    return mongoose_obj
      ...
      .then(function() {
        ...
        if(_user_id) jsObject.user_id = _user_id;
        return jsObject;
      });
  },
